...
<head>
    ...
    <title>Waste Recycler</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon -->
    
    <link rel="shortcut icon" type="image/x-icon" href="/assets/img/logo/logo-3.png">
    ...
    <header>
                ...
                <div class="electronics-login-register">
                    <ul>
                       ...
                       @endguest -->
                        ...
                        <li><a href="{{route('shop.create')}}">                           
                           <div class=""><button>Open Your Shop</button>
                       </a>
                    </li>
        ...
        <div class="header-bottom pt-40 pb-30 clearfix">
            <div class="header-bottom-wrapper pr-200 pl-200">
                <div class="logo-3  ">
                    <a href="{{route('home')}}">
                        <img height="60" width="160" src="/assets/img/logo/logo-3.png" alt="">
                    </a>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-7">
                        <div class="copyright f-right mrg-5">
                            <p>
                                Copyright ©
                                <a href=""></a> 2018 . All Right Reserved.
                            </p>
                        </div>
                    </div>
                </div>
